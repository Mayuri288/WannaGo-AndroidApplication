...
import com.bignerdranch.android.wannago.databinding.FragmentRestaurantDetailBinding
...
class RestaurantDetailFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val args = arguments?.let { RestaurantDetailFragmentArgs.fromBundle(it) }
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        val location = arguments?.let { RestaurantDetailFragmentArgs.fromBundle(it)?.location }
        if (location != null) {
